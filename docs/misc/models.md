...
\dot{x}_{1} &= x_{1} (1-(x_{1}+0.85 x_{2} + 0.5 x_{0})) \\
\dot{x}_{2} &= x_{2} (1-(x_{2}+0.85 x_{3} + 0.5 x_{1})) \\
\dot{x}_{3} &= x_{3} (1-(x_{3}+0.85 x_{4} + 0.5 x_{2})) \\
\dot{x}_{4} &= x_{4} (1-(x_{4}+0.85 x_{0} + 0.5 x_{3})) \\
\end{align*}
$$
...
$$
\begin{align*}
\dot{x}_{0} &= -0.101 (x_{0}-20) + 1.3203 (x_{1} - 0.1616) - 0.01 x_{0}^2 \\
